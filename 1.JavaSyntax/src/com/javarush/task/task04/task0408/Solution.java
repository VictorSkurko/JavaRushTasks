...
/* 
Хорошо или плохо?
У обучающегося робота Петра — комплекс отличника.
Раньше на его сервере выставляли оценки по пятибалльной системе,
а сейчас перешли на 12-балльную.
Но Петр об этом не знает, и по-прежнему ориентируется на «пятерки».
Напишем для него метод compare, который сравнивает любое введенное число с пятеркой.
